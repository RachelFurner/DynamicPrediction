...
# Read in predictions
#----------------------
root_dir = '/data/hpcdata/users/racfur/DynamicPrediction/RegressionOutputs/'
pred_dir = root_dir+'ITERATED_PREDICTION_ARRAYS/'
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_predictions_z'+str(level), bbox_inches = 'tight', pad_inches = 0.1)
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_Diff_z'+str(level), bbox_inches = 'tight', pad_inches = 0.1)
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_predictions_y'+str(y_coord), bbox_inches = 'tight', pad_inches = 0.1)
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_Diff_y'+str(y_coord), bbox_inches = 'tight', pad_inches = 0.1)
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_predictions_x'+str(x_coord), bbox_inches = 'tight', pad_inches = 0.1)
...
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_Diff_x'+str(x_coord), bbox_inches = 'tight', pad_inches = 0.1)
...
fig = rfplt.plt_timeseries(point, 120, {'da_T (truth)':da_T.data, 'persistence':persistence, 'model': field})

fig = rfplt.plt_3_timeseries(point, 120, 1200, 12000, {'da_T (truth)':da_T.data, 'persistence':persistence, 'model':field})
plt.savefig(root_dir+'PLOTS/'+model_type+'_'+exp_name+'_multimodel_forecast_1000yrs_z'+str(point[0])+'y'+str(point[1])+'x'+str(point[2])+'y', bbox_inches = 'tight', pad_inches = 0.1)
