...
train1test2 = second_order_integrator(L95_X[0,:], h1, forecast_len/int_t)
train2test2 = second_order_integrator(L95_X[0,:], h2, forecast_len/int_t)

# Plot it..
plt.plot(L95_X[:forecast_len/int_t,xi])
plt.ylim(-30,30)
