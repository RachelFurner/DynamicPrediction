...
no_epochs = 50          # When running with 100ts code its just so slow, and so limiting this in order to get some resultsin D&B paper the NN's were trained for at least 200 epochs
#n_run = 512     # Testing
#no_epochs = 5   # Testing
learning_rate = 0.001
