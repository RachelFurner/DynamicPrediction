...
for epochs in epochs_list:
   ...
   plt.savefig(rootdir+'/EXAMPLE_PREDICTIONS/'+model_name+'_Temp_predicted_z'+str(level)+'_'+trainval+'.png', bbox_inches = 'tight', pad_inches = 0.1)
   ...
   plt.savefig(rootdir+'/EXAMPLE_PREDICTIONS/'+model_name+'_U_predicted_z'+str(level)+'_'+trainval+'.png', bbox_inches = 'tight', pad_inches = 0.1)
   
   fig = ChnPlt.plot_depth_fld(np.where(masks[level,:,:]==1, da_Pred_V.values[time,level,:,:], np.nan), 'Predicted North-South Velocity',
                               level, da_X.values, da_Y.values, da_Z.values, title=None)
   plt.savefig(rootdir+'/EXAMPLE_PREDICTIONS/'+model_name+'_V_predicted_z'+str(level)+'_'+trainval+'.png', bbox_inches = 'tight', pad_inches = 0.1)
   ...
   plt.savefig(rootdir+'/EXAMPLE_PREDICTIONS/'+model_name+'_Eta_predicted_'+trainval+'.png', bbox_inches = 'tight', pad_inches = 0.1)
