...
# 24hourly UNet
model4=IncLand12hrly_UNet2dtransp_histlen1_rolllen1_seed30475
...
#
convert ${plot1_name}_time014.png ${plot2_name}_time014.png ${plot3_name}_time014.png ${plot6_name}_time014.png ${plot7_name}_time014.png  -append tmpa.png

convert ${plot1_name}_time028.png ${plot2_name}_time028.png ${plot3_name}_time028.png ${plot6_name}_time028.png ${plot7_name}_time028.png -append tmpb.png

convert ${plot1_name}_time056.png ${plot2_name}_time056.png ${plot3_name}_time056.png ${plot6_name}_time056.png ${plot7_name}_time056.png -append tmpc.png

convert ${plot1_name}_time084.png ${plot2_name}_time084.png ${plot3_name}_time084.png ${plot6_name}_time084.png ${plot7_name}_time084.png -append tmpd.png
