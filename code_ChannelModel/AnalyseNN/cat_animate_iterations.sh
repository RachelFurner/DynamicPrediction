model_name='Spits12hrly_UNetConvLSTM_histlen5_rolllen1_seed30475'
#model_name='MultiModel_Spits12hrly_UNet2dtransp_histlen1_rolllen1'
epochs='200'
...
convert $dir/PLOTS/${plot_name}_Temp_level2_time028.png $dir/PLOTS/${plot_name}_Temp_level2_time056.png \
        $dir/PLOTS/${plot_name}_Temp_level2_time084.png $dir/PLOTS/${plot_name}_Temp_level2_time112.png \
